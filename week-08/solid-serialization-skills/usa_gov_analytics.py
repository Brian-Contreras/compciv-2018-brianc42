...
DEST_DIR = 'data-files'
SRC_URL = 'http://stash.compciv.org/2017/analytics.usa.gov-top-traffic-sources-30-days.csv'
...
def parse_records():
    src_data_filename = fetch_and_save_url(SRC_URL)
